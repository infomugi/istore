...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textArea($model,'spesification',array('rows'=>6, 'cols'=>50)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'keyword',array('size'=>60,'maxlength'=>150)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'abstrack'); ?>
		<?php echo $form->textField($model,'abstrack',array('size'=>60,'maxlength'=>255)); ?>
	</div>
