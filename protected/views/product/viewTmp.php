      ...
      <div class="col-main">
        <div class="product-view-area">
          <div class="product-big-image col-xs-12 col-sm-5 col-lg-5 col-md-5">
            ...
            <div class="large-image"> <a href='images/productimages/img04.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'images/productimages/img04.jpg' "><img src="images/productimages/img04.jpg" alt = "Thumbnail 2"/></a> </div>
      <!--  <div class="flexslider flexslider-thumb">
          ...
          <div class="col-xs-12 col-sm-7 col-lg-7 col-md-7 product-details-area">
              ...
              <div class="product-cart-option">
                <ul>
                  <li><a href="single_product.html#"><i class="fa fa-heart"></i><span>Add to Wishlist</span></a></li>
                  <li><a href="single_product.html#"><i class="fa fa-retweet"></i><span>Add to Compare</span></a></li>
                </ul>
