      	...
      	<header>
      					...
      					<div class="row">
      						<div class="col-lg-4 col-sm-4 hidden-xs"> 
      							...
      							<div class="headerlinkmenu col-lg-8 col-md-7 col-sm-8 col-xs-12">
      								<div class="links">
      									<div class="myaccount">
                                                                  <a title="My Account" href="<?php echo $baseUrl;?>/"><i class="fa fa-user"></i><span class="hidden-xs">My Account</span></a>
                                                            </div>
                                                            <div class="login"><a href="<?php echo $baseUrl;?>/"><i class="fa fa-unlock-alt"></i><span class="hidden-xs">Log In</span></a></div>
                                                      </div>
           ...
           <div class="col-lg-3 col-xs-3 top-cart">
             <div class="top-cart-contain">
              <div class="mini-cart">
               <div data-toggle="dropdown" data-hover="dropdown" class="basket dropdown-toggle"> <a href="<?php echo $baseUrl;?>/#">
